...
<div class="login-box">
  ...
  <div class="card card-outline card-primary">
    <div class="card-header text-center">
      <img src="/res/admin/dist/img/AdminLTELogo3.png">
      <!-- <a href="/res/admin/index2.html" class="h1"><b>Sistema de Fretes</b></a> -->
    </div>
    <div class="card-body">
      ...
      <p class="mb-1">
        <a href="/res/admin/forgot-password.html">Esqueci minha senha</a>
      </p>
      <p class="mb-0">
        <a href="/res/admin/register.html" class="text-center">Registrar-se</a>
      </p>
    </div>
    <!-- /.card-body -->
  </div>
